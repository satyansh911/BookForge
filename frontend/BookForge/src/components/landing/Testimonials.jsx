...
const Testimonials = () => {
  return (
    <div id="testimonials" className='relative py-24lg:py-32 bg-gradient-to-br from-violet-50 via-pruple-50 to-white overflow-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8 relative'>
            <div className='text-center mb-20 space-y-4'>
                ...
                <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
                    Don't just take our word for it. Hear from our satisfied users who have transformed their ebook creation process with BookForge.
                </p>
            </div>
            ...
            <div className='mt-20 mb-30 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto'>
